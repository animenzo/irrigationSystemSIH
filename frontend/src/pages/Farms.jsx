...
function StatusBadge({ status }) {
  ...
  return (
    <span
      className={`px-2 py-0.5 rounded-full text-xs font-semibold ${status === "Active"
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-2 text-gray-600">
                ...
                <p className="text-sm text-gray-500">
                  {farm.tankDetails.type === 'circle'
                    ? `Circle tank, Radius: ${farm.tankDetails.dimensions.diameter/2}`
                    : `Rectangle tank, Length: ${farm.tankDetails.dimensions.length}, Height: ${farm.tankDetails.dimensions.height}`}
                </p>
              </div>
            </div>
          ))
        ...
        >
          <div className="flex justify-between items-start mb-4">
            <h2 className="text-xl font-bold text-gray-900">North Farm</h2>
            <StatusBadge status="Active" />
          </div>
          <div className="space-y-2 text-gray-600">
            <p className="flex items-center">
