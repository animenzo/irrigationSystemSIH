...
const blynkRoutes = require('./routes/blynkRoutes');
const authRoutes = require('./routes/authRoutes');  // ⬅️ NEW
...
app.use(cors({
    origin:[
        ...
        "http://localhost:5174",
        "http://localhost:3000",
        "https://smart-kheti-nine.vercel.app/"
...
// Domain routes
app.use('/api/farms', farmRoutes);     // /api/farms...
app.use('/api/schedules', scheduleRoutes);
app.use('/api', irrigationRoutes);     // /api/irrigation, /api/pump
app.use('/api', sensorRoutes);         // /api/sensors, /api/sensor-data, /api/historical-data, /api/test-save-sensor
app.use('/api/blynk', blynkRoutes);    // /api/blynk/...
